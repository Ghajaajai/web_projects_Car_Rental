...
<div class="form-group">
<label class="col-sm-2 control-label">Harga(Rupiah/hari))<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="priceperday" class="form-control" value="<?php echo htmlentities($result->PricePerDay);?>" required>
</div>
<label class="col-sm-2 control-label">Select Jenis Bahan Bakar<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">Tahun Rilis<span style="color:red">*</span></label>
<div class="col-sm-4">
