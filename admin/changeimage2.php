						...
						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Gambar Mobil 2</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Gambar Mobil 2</label>
<?php 
$id=intval($_GET['imgid']);
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Upload Gambar Mobil 2<span style="color:red">*</span></label>
												<div class="col-sm-8">
