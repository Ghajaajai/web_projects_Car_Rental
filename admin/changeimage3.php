						...
						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Gambar Mobil 3</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Gambar Mobil 3</label>
<?php 
$id=intval($_GET['imgid']);
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Upload Gambar Mobil 3<span style="color:red">*</span></label>
												<div class="col-sm-8">
